    ...
    <>
      <div className="flex-1 flex flex-col h-full overflow-hidden bg-white dark:bg-slate-900 border-l border-slate-200/80 dark:border-slate-800">
        ...
        <div className="h-16 px-4 border-b border-slate-200/80 dark:border-slate-800 flex items-center justify-between shrink-0 select-none bg-white dark:bg-slate-900">
          ...
          <button
            onClick={onClose}
            className="p-1.5 rounded-lg text-slate-400 hover:text-slate-650 hover:bg-slate-100 dark:hover:bg-slate-800 cursor-pointer"
          >
        ...
        <div className="flex-1 overflow-y-auto no-scrollbar">
          ...
          <div className="px-6 pt-8 pb-6 flex flex-col items-center text-center border-b border-slate-100 dark:border-slate-800">
            <div className="mb-3.5 relative inline-block">
              <Avatar
                ...
                className="shadow-md ring-4 ring-slate-100 dark:ring-slate-800/80"
              />
            </div>

            <div className="flex items-center justify-center gap-2 max-w-full">
              <h3 className="text-lg font-black text-slate-900 dark:text-white flex items-center gap-1.5 truncate">
                {title}
              ...
              {amIAdmin && (
                <button
                  ...
                  className="p-1.5 rounded-full bg-slate-100 dark:bg-slate-800 text-indigo-600 dark:text-indigo-400 hover:bg-indigo-100 dark:hover:bg-indigo-500/20 cursor-pointer transition-all shrink-0 hover:scale-110"
                >
            ...
            {isDirect && (
              <p className="text-[11px] text-indigo-600 dark:text-indigo-400 mt-1 font-black uppercase tracking-wider">
                {recipient?.statusText || "Active Member"}
              </p>
            )}


            <p className="text-xs text-slate-600 dark:text-slate-300 mt-3 max-w-xs leading-relaxed font-semibold">
          ...
          {/* Detailed parameters */}
          {isDirect && recipient && (
            <div className="p-4 border-b border-slate-100 dark:border-slate-800 text-left text-xs font-medium">
              <div className="flex items-center gap-3">
                <Mail className="h-4 w-4 text-indigo-600 dark:text-indigo-400" />
                <div>
                  <span className="text-[10px] text-slate-500 dark:text-slate-400 block uppercase font-bold tracking-wider">Email Address</span>
                  <span className="text-slate-900 dark:text-white font-black select-all">{recipient.email}</span>
                </div>
              </div>
            </div>
          )}
          ...
          {!isDirect && group && (
            <div className="p-4 border-b border-slate-100 dark:border-slate-800 text-left space-y-3.5 select-none">
              <div className="flex items-center justify-between">
                <h4 className="text-xs font-black text-slate-900 dark:text-white flex items-center gap-1.5 tracking-wide uppercase">
              ...
              <div className="bg-slate-50 dark:bg-slate-800/60 rounded-2xl p-3.5 border border-slate-200/80 dark:border-slate-750 space-y-3">
                ...
                <div className="flex items-center justify-between gap-3">
                  <div className="min-w-0 flex-1">
                    ...
                    <span className="text-[10px] text-slate-500 dark:text-slate-400 block font-semibold truncate mt-0.5">
                  ...
                  <button
                    ...
                    className={`relative inline-flex h-5 w-9 shrink-0 rounded-full border-2 border-transparent transition-colors duration-200 ease-in-out focus:outline-none ${(group.permissions?.sendMessages !== false) ? 'bg-indigo-600' : 'bg-slate-300 dark:bg-slate-700'
                      } ${!amIAdmin ? 'opacity-60 cursor-not-allowed' : 'cursor-pointer'}`}
                  >
                    <span
                      className={`pointer-events-none inline-block h-4 w-4 transform rounded-full bg-white shadow-lg ring-0 transition duration-200 ease-in-out ${(group.permissions?.sendMessages !== false) ? 'translate-x-4' : 'translate-x-0'
                        }`}
                    />
                  </button>
                </div>
                ...
                <div className="flex items-center justify-between gap-3 pt-2.5 border-t border-slate-200/60 dark:border-slate-750">
                  <div className="min-w-0 flex-1">
                    <span className="text-xs font-bold text-slate-800 dark:text-slate-200 block truncate">
                      Add other members
                    </span>
                  ...
                  <button
                    ...
                    className={`relative inline-flex h-5 w-9 shrink-0 rounded-full border-2 border-transparent transition-colors duration-200 ease-in-out focus:outline-none ${(group.permissions?.addMembers !== false) ? 'bg-indigo-600' : 'bg-slate-300 dark:bg-slate-700'
                      } ${!amIAdmin ? 'opacity-60 cursor-not-allowed' : 'cursor-pointer'}`}
                  >
                    <span
                      className={`pointer-events-none inline-block h-4 w-4 transform rounded-full bg-white shadow-lg ring-0 transition duration-200 ease-in-out ${(group.permissions?.addMembers !== false) ? 'translate-x-4' : 'translate-x-0'
                        }`}
                    />
                  </button>
                </div>
              ...
              <div className="bg-slate-50 dark:bg-slate-800/60 rounded-2xl p-3.5 border border-slate-200/80 dark:border-slate-750 space-y-3">
                ...
                <div className="flex items-center justify-between gap-3">
                  ...
                  <button
                    ...
                    className={`relative inline-flex h-5 w-9 shrink-0 rounded-full border-2 border-transparent transition-colors duration-200 ease-in-out focus:outline-none ${group.permissions?.approveMembers ? 'bg-indigo-600' : 'bg-slate-300 dark:bg-slate-700'
                      } ${!amIAdmin ? 'opacity-60 cursor-not-allowed' : 'cursor-pointer'}`}
                  >
                    <span
                      className={`pointer-events-none inline-block h-4 w-4 transform rounded-full bg-white shadow-lg ring-0 transition duration-200 ease-in-out ${group.permissions?.approveMembers ? 'translate-x-4' : 'translate-x-0'
                        }`}
                    />
                  </button>
                </div>
          ...
          {/* Group member roster */}
          {!isDirect && group && (
            <div className="p-4 border-b border-slate-100 dark:border-slate-800 text-left relative">
              ...
              <h4 className="text-xs font-black text-slate-900 dark:text-white flex items-center gap-1.5 mb-3.5 tracking-wide uppercase">
                  ...
                  return (
                    <div key={mid} className={`relative ${isMenuOpen ? 'z-50' : 'z-1'}`}>
                      <div
                        ...
                        className={`flex items-center justify-between p-3 rounded-2xl bg-slate-50 dark:bg-slate-800/80 border border-slate-200 dark:border-slate-750 shadow-2xs transition-all ${!isMe ? 'cursor-pointer hover:bg-slate-100/80 dark:hover:bg-slate-750 hover:border-indigo-300 dark:hover:border-slate-650' : 'cursor-default'
                          } ${isMenuOpen ? 'ring-2 ring-indigo-500/30 border-indigo-400 dark:border-indigo-500' : ''}`}
                      >
                        <div className="flex items-center gap-3 min-w-0">
                          ...
                          <div className="text-xs text-left min-w-0">
                            <span className="font-black text-slate-900 dark:text-white block truncate text-xs leading-tight">
                              {member.name} {isMe && "(You)"}
                            </span>
                            <span className="text-[11px] font-semibold text-slate-500 dark:text-slate-400 block truncate mt-0.5">
                        ...
                        <div className="flex items-center gap-2 shrink-0">
                          {isTargetAdmin && (
                            <span className="px-2 py-0.5 rounded-md bg-emerald-500/15 text-emerald-600 dark:text-emerald-400 border border-emerald-500/20 text-[10px] font-black uppercase tracking-wider">
                              Group admin
                            </span>
                          )}
                          ...
                          {!isMe && (
                            <button
                              ...
                              className="p-1 rounded-lg text-slate-400 hover:text-slate-700 dark:hover:text-white hover:bg-slate-200/60 dark:hover:bg-slate-700 cursor-pointer transition-all shrink-0"
                              title="Member options"
                            >
                              <ChevronDown className={`h-4 w-4 transition-transform duration-200 ${isMenuOpen ? 'rotate-180 text-indigo-600 dark:text-indigo-400' : ''}`} />
                            </button>
                          )}
                        </div>
                      </div>
          ...
          <div className="p-4 text-left">
            ...
            <div className="px-4 py-2 border-t border-slate-100 dark:border-slate-800/80 text-left">
              <button
                onClick={() => setShowStarredView(true)}
                className="w-full py-2.5 px-3.5 rounded-xl border border-slate-200/80 dark:border-slate-800 hover:bg-slate-50 dark:hover:bg-slate-850 text-slate-800 dark:text-slate-200 flex items-center justify-between text-xs font-bold transition-all cursor-pointer select-none"
              >
            ...
            <div className="p-4 border-t border-slate-100 dark:border-slate-800/80 space-y-2 text-left">
              {isDirect ? (
                <>
                  <button
                    onClick={() => setIsBlockModalOpen(true)}
                    className="w-full py-2.5 px-3.5 rounded-xl border border-rose-500/10 hover:bg-rose-500/10 text-rose-600 dark:text-rose-400 flex items-center gap-2 text-xs font-bold transition-colors cursor-pointer select-none"
                  >
                  ...
                  <button
                    ...
                    className="w-full py-2.5 px-3.5 rounded-xl hover:bg-slate-100 dark:hover:bg-slate-850 text-slate-500 dark:text-slate-400 flex items-center gap-2 text-xs font-bold transition-colors cursor-pointer select-none"
                  >
                ...
                <>
                  {(amIAdmin || group.permissions?.addMembers !== false) && (
                    <button
                      ...
                      className="w-full py-2.5 px-3.5 rounded-xl border border-indigo-500/20 hover:bg-indigo-50 dark:hover:bg-indigo-500/10 text-indigo-600 dark:text-indigo-400 flex items-center gap-2 text-xs font-bold transition-colors cursor-pointer select-none"
                    >
                  ...
                  {amIAdmin && (
                    <button
                      ...
                      className="w-full py-2.5 px-3.5 rounded-xl border border-transparent hover:bg-rose-650 hover:text-white dark:hover:bg-rose-600 text-rose-650 dark:text-rose-400 flex items-center gap-2 text-xs font-bold transition-colors cursor-pointer select-none"
                    >
